...
if __name__ == "__main__":
    ...
    for i in range(4):
        semantic_embeddings = read_embeddings(output_dir / f"semantic-{i}.json")
        print(i, msl_correlation(msl, semantic_embeddings))
    onehot_embeddings = read_embeddings(output_dir / "one-hot.json")
    print(msl_correlation(msl, onehot_embeddings))
